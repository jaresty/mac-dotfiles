...
MOVEMENT_TYPE: dict[str, tuple[callable, callable, int]] = {
    ...
    "stepping": (actions.edit.right, actions.edit.word_left, 1),
    "slinking": (actions.edit.left, actions.edit.word_right, 1),
    ...
    "snatching": (actions.edit.extend_right, actions.edit.extend_word_left, 1),
    "chancing": (actions.edit.extend_left, actions.edit.extend_word_right, 1),
