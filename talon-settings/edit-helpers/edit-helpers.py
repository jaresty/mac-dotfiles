...
MOVEMENT_TYPE: dict[str, tuple[callable, callable, int]] = {
    ...
    "onstepping": (actions.edit.right, actions.edit.left, 1),
    ...
    "onsnatching": (actions.edit.extend_right, actions.edit.extend_left, 1),
    ...
    "navi stepping": (actions.user.go_forward, actions.user.go_back, 4),
    "chase stepping": (actions.user.next_reference, actions.user.last_reference, 4),
    "chase restepping": (actions.user.last_reference, actions.user.next_reference, 4),
    ...
    "onpanning": (actions.user.mouse_scroll_right, actions.user.mouse_scroll_left, 2),
