...
MOVEMENT_TYPE: dict[str, tuple[callable, int]] = {
    ...
    "steppy": (actions.edit.right, 1),
    "slinky": (actions.edit.left, 1),
    "step": (actions.edit.word_right, 2),
    "slink": (actions.edit.word_left, 2),
    "dust": (actions.edit.extend_line_up, 2),
    "sweep": (actions.edit.extend_line_down, 2),
    "snatchy": (actions.edit.extend_right, 1),
    "chancy": (actions.edit.extend_left, 1),
